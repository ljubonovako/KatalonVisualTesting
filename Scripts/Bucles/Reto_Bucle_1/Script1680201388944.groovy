...
for (int i = 1; i <= 3; i++) {
    ...
    WebUI.setText(findTestObject('Bucles/Page_DEMOQA/Page_DEMOQA/input_Full Name_userName'), 'Juan' + num)

    WebUI.setText(findTestObject('Bucles/Page_DEMOQA/Page_DEMOQA/input_Email_userEmail'), ('correo' + num) + '@gmail.com')
