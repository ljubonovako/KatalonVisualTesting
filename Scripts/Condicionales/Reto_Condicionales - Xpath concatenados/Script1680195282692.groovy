...
nombre = WebUI.waitForElementVisible(findTestObject('Condicionales/Page_DEMOQA/input_Name_firstName'), 3)

apellido = WebUI.waitForElementVisible(findTestObject('Condicionales/Page_DEMOQA/input_Name_firstName'), 3)
