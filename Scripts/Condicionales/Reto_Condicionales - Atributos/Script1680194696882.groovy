...
nombre = WebUI.waitForElementAttributeValue(findTestObject('Condicionales/Page_DEMOQA/input_Name_firstName'), '0', '0', 
    3)

apellido = WebUI.waitForElementAttributeValue(findTestObject('Condicionales/Page_DEMOQA/input_Name_lastName'), '0', '0', 
    3)
